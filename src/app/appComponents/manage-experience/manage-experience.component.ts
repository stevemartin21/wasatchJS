...
export class ManageExperienceComponent implements OnInit {
  ...
  addPaginators() {
    if (this.experiences.length % this.itemsPerPage === 0) {
      this.numberOfPaginators = Math.floor(this.experiences.length / this.itemsPerPage);
    } else {
      this.numberOfPaginators = Math.floor(this.experiences.length / this.itemsPerPage + 1);
    }
